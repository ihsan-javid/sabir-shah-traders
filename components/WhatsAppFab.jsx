  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      <Magnetic strength={0.3}>
        <Tooltip content="Chat on WhatsApp" position="left">
          <motion.a
            href={href}
            target="_blank"
            ...
            className="group relative flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-2xl overflow-hidden cursor-pointer"
            aria-label="WhatsApp"
          >
