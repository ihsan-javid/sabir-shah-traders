export const products = [
  {
    ...
    rating: 4.9,
    reviews: 512,
    benefits: ["24g Protein / Scoop", "Whey Isolate", "Fast Absorbing", "No Added Sugar"],
    stock: 24,
    popularity: 98,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 241,
    benefits: ["A–Z Vitamins", "Immunity Support", "Daily Energy", "Vegetarian"],
    stock: 60,
    popularity: 84,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 188,
    benefits: ["1000mg EPA+DHA", "Heart Health", "Brain Support", "Triple Strength"],
    stock: 0,
    popularity: 91,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 134,
    benefits: ["1000mg Vitamin C", "Bioflavonoids", "Immune Boost", "Antioxidant"],
    stock: 42,
    popularity: 70,
