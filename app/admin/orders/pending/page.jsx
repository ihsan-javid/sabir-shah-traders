...
export default function OrdersPendingPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Orders Pending</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Orders Pending module is currently under development. This feature will allow you to manage orders pending for Sabir Shah Traders.
      </p>
