...
export default function OrdersRefundsPage() {
  return (
    <motion.div 
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Orders Refunds</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Orders Refunds module is currently under development. This feature will allow you to manage orders refunds for Sabir Shah Traders.
      </p>
