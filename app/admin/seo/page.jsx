...
export default function SeoPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Seo</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Seo module is currently under development. This feature will allow you to manage seo for Sabir Shah Traders.
      </p>
