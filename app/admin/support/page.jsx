...
export default function SupportPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Support</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Support module is currently under development. This feature will allow you to manage support for Sabir Shah Traders.
      </p>
