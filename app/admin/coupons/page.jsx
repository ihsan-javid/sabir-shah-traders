...
export default function CouponsPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Coupons</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Coupons module is currently under development. This feature will allow you to manage coupons for Sabir Shah Traders.
      </p>
