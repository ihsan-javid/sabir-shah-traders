...
export default function AiPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Ai</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Ai module is currently under development. This feature will allow you to manage ai for Sabir Shah Traders.
      </p>
