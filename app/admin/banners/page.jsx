...
export default function BannersPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Banners</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Banners module is currently under development. This feature will allow you to manage banners for Sabir Shah Traders.
      </p>
