...
export default function LogsPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Logs</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Logs module is currently under development. This feature will allow you to manage logs for Sabir Shah Traders.
      </p>
