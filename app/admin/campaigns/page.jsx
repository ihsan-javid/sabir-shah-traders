...
export default function CampaignsPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Campaigns</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Campaigns module is currently under development. This feature will allow you to manage campaigns for Sabir Shah Traders.
      </p>
