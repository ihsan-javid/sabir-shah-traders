...
export default function PredictionsPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Predictions</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Predictions module is currently under development. This feature will allow you to manage predictions for Sabir Shah Traders.
      </p>
