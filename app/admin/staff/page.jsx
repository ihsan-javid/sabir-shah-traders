...
export default function StaffPage() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold font-display tracking-tight text-white">Staff</h1>
      <p className="text-white/40 mt-4 max-w-md">
        The Staff module is currently under development. This feature will allow you to manage staff for Sabir Shah Traders.
      </p>
