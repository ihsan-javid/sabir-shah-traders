        ...
        <div className="mx-auto max-w-6xl px-5 lg:px-8 grid gap-10 lg:grid-cols-[1fr_400px]">
          ...
          >
            ...
            >
              ...
              <div className="text-sm text-muted-foreground mt-1">+92 300 0000000</div>
            ...
            <div className="rounded-2xl glass p-5">
              ...
              <div className="text-sm text-muted-foreground mt-1">hello@sabirshah.pk</div>
            </div>
            <div className="rounded-2xl glass p-5">
              <MapPin className="h-5 w-5 text-gold" />
              <div className="mt-3 font-semibold">Office</div>
              <div className="text-sm text-muted-foreground mt-1">Karachi, Pakistan</div>
            </div>
          </motion.div>
        </div>
      </section>
